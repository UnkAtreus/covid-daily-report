...
const Home: NextPage = () => {
  ...
  const formPageRender = () => {
    switch (page) {
      case 0:
        return <PersonalInfo nextPage={nextPage} data={data} setData={setData} />;
      case 1:
        return (
          <ContactInfo
            nextPage={nextPage}
      ...
      <div className="h-full" style={{ background: '#F3E9E8' }}>
        <Row className="mb-8">
          <div
            ...
            <div className="text-center text-white text-2xl mb-2">Home Isolation</div>
          ...
          <Col
            ...
            md={{ span: 16, offset: 4 }}
            lg={{ span: 12, offset: 6 }}>
            <div className="rounded-2xl bg-white px-8 shadow-md pt-10 -mt-8 pb-4 sm:mt-0 sm:pt-16 mb-12">
              {formPageRender()}
            </div>
          </Col>
        </Row>
